...
loadVerifiedEvidence[input_Association, workspaceRoot_String] := Module[
    {reference, path, evidence, actualHash, events, eventKeys, eventSeries, table, sequences},
    ...
    ensureCondition[evidence["schema_version"] === "1.0.0" && evidence["evidence_type"] === "BABELAPHA_LOCAL_SOURCE_V1", IntegrityException, "UNSUPPORTED_EVIDENCE", "The evidence document has an unsupported type or version.", 11];
    ...
    ensureCondition[ListQ[events] && Length[events] >= 2, IntegrityException, "INVALID_EVIDENCE_EVENTS", "Evidence must contain at least two events.", 11];
    ...
    <|
        ...
        "summary" -> <|
            ...
            "artifact_count" -> Max[Lookup[events, "artifact_count"]],
